...
import { superDragonsLair } from './5-super-dragons-lair';
import { greenWild } from './6-greenwild';
import { lethalWing } from './7-lethal-wing';

export const gamesPortfolio: PortfolioItem[] = [supperCannonBlast, climberPlumber, pokeClon, superDragonsLair, timberChopper, greenWild, lethalWing];
